...
harness — see the [Harness Comparison](../harness-comparison.md) for the full table.
...
- [Authoring a skill (guide)](../guides/authoring.md) — writing effective, portable skills.
- [Canonical skills (concept)](../concepts/canonical-skills.md) — the data model in depth.
