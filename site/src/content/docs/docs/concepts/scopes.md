---
title: "Scopes"
description: "A scope decides where adept reads and writes its metadata, skills, and materialized files."
---
...
[Harnesses & adapters](/docs/concepts/harnesses/#global-support).
...
- [Libraries](/docs/concepts/libraries/) — project-local clones vs. the machine store, and how the two
  interact with scope.
- [Harnesses & adapters](/docs/concepts/harnesses/) — the full adapter table, including the Global column.
