...
description: "Skills make knowledge portable; agents make delegation portable across every harness."
---
...
See the [command reference](/docs/reference/commands/#agent) for the full `adept agent`
