---
title: "Libraries"
description: "A library is a shared, versioned set of skills a team authors once and reuses everywhere."
---
...
[global scope](/docs/concepts/scopes/) keeps its own skills, config, and library clones. Two things fall
...
see [Scopes](/docs/concepts/scopes/).
...
[3-way drift model](/docs/concepts/drift/) that lets `adept` tell "you edited it" apart from "upstream
changed it."

## Related

- [Sharing a library with a team (guide)](/docs/guides/sharing-a-library/)
- [Vendoring a library in-repo (guide)](/docs/guides/vendoring/)
- [Layouts](/docs/concepts/layouts/) — consumer vs. publishable-library layout.
