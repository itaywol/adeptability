...
description: "The canonical skill is adept's single source of truth for everything it renders."
---
...
Where `<canonical>` lives depends on the project [layout](/docs/concepts/layouts/):
...
[drift detection](/docs/concepts/drift/): `adept` compares hashes of the project canonical, the last-synced
...
2. Skills from each configured [library](/docs/concepts/libraries/), in order
