...
See the [Harness Comparison](/docs/harness-comparison/) for exactly what each renderer emits
and why it differs, and [Scopes](/docs/concepts/scopes/) for what `--global` changes and why Cursor and
...
Copilot adapters. See [Scopes](/docs/concepts/scopes/) for the full global-scope model.
