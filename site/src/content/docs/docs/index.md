---
title: "adeptability"
description: "Write an AI coding skill once, run it in every AI coding assistant."
---
...
- 📦 **[Install](/docs/getting-started/install/)** — Go, Homebrew, curl, Docker.
- 🚀 **[Quickstart](/docs/getting-started/quickstart/)** — author, sync, and see it in your harness in 60 seconds.
- 💡 **[Concepts](/docs/concepts/canonical-skills/)** — canonical skills, harnesses, libraries, layouts, drift.
- ⌨️ **[Command reference](/docs/reference/commands/)** — every command and flag.
