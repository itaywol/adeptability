...
description: "How a single canonical skill produces correct output for every supported harness."
---
...
registry, or add your own with a [config-driven adapter](/docs/concepts/harnesses/#config-driven-adapters-no-recompile).
