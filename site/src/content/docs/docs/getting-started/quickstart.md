---
title: "Quickstart"
description: "Author a skill once and watch it materialize into every enabled harness in about a minute."
---
...
- [Author a robust, portable skill](/docs/guides/authoring/)
- [Share a library across your team](/docs/guides/sharing-a-library/)
- [Full command reference](/docs/reference/commands/)
