...
description: "Every adept command and flag, generated faithfully from the cobra definitions."
---
...
plus a schedule that lives in CI or the harness. See the [loops guide](/docs/guides/loops/).
...
Manage the project's library remotes. See [Libraries](/docs/concepts/libraries/).
...
Manage the git pre-commit drift hook. See the [Git drift hook guide](/docs/guides/git-hook/).
...
[Exchange](/docs/exchange/). A shared `--server <url>` flag applies to every client subcommand
