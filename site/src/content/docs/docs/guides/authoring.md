...
description: "Write a canonical skill that renders well across every harness."
---
...
The [Harness Comparison](/docs/harness-comparison/) shows the exact translation per activation
mode.
