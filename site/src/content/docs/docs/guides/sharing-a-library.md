---
title: "Sharing a library across a team"
description: "Author skills once, publish them as a library, and let every project and teammate consume them."
---

Author skills once, publish them as a library, and let every project and teammate consume them
by reference. Read [Libraries](/docs/concepts/libraries/) first for the package-manager model.
...
See [Libraries → Teammate onboarding flow](/docs/concepts/libraries/#teammate-onboarding-flow)
