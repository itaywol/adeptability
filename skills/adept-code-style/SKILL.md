---
id: adept-code-style
description: Go code style and conventions for the adept codebase — formatting, linters, error wrapping with sentinels, the composition-root/no-globals rule, and core invariants. Apply when writing or reviewing Go in this repo.
activation: globs
globs: ["**/*.go"]
allowed-tools: [Read, Grep, Edit]
tags: [adept, go, style, conventions]
metadata:
