...
description: How to write tests in the adept Go codebase — table-driven tests with testify, golden fixtures under testdata/, the cmd/adept e2e harness, temp-dir/HOME isolation, and coverage gates. Apply when adding or changing Go tests here.
activation: globs
globs: ["**/*_test.go"]
allowed-tools: [Read, Grep, Edit, Write, Bash]
tags: [adept, testing, go]
metadata:
